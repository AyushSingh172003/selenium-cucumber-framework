...
public class ProductSteps {
    ...
    public void the_user_is_logged_in_with_valid_credentials() {
        ...
        homePage = loginPage.login(config.getValidUsername(), config.getValidPassword());
    ...
    public void the_product_prices_should_be_in_ascending_order() {
        ...
        Assert.assertEquals(prices, sortedCopy, "Prices are not in ascending order: " + prices);
    ...
    public void the_cart_badge_should_show(String expectedCount) {
        ...
        log.info("Verified cart badge: {}", actual);
    }
